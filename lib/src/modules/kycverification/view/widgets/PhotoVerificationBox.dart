...
class PhotoVerificationBox extends StatelessWidget {
  final KycController controller = Get.find<KycController>();
  final VoidCallback onTap;

  PhotoVerificationBox({super.key, required this.onTap});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          /// Title
          Text("Photo Verification", style: photoverifictStyle),
          ...
          Center(
            child: Obx(() {
              File? image = controller.selfieImage.value;
